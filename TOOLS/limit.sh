#!/bin/bash
REPO="https://raw.githubusercontent.com/mohamadrojib278/genom/refs/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://github.com/mohamadrojib278/genom/raw/refs/heads/main/TOOLS/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
